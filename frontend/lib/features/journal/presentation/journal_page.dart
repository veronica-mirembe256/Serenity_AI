...
class _JournalPageState extends ConsumerState<JournalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Debug logging
    print('🖥️ [UI] Journal state: isSubmitting=${journal.isSubmitting}, hasResult=${result != null}, error=${journal.error}');
    if (result != null) {
      print('🖥️ [UI] Result: ${result.detectedEmotion}');
      print('🖥️ [UI] Risk: ${result.relapseRiskLevel}');
      print('🖥️ [UI] Recommendations: ${result.recommendations.length}');
      print('🖥️ [UI] Streak: ${result.streak}');
    }
          ...
          children: [
            ...
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(width: 10),
                Expanded(
                  child: Text(result.encouragementMessage,
